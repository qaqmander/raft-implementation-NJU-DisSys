...
func TestInitialElectionPart1(t *testing.T) {
	servers := 3
...
func TestReElectionPart1(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
	...
	//PlainDPrintf("[IMPORTANT] After first leader's disconnection, only %d disconnects\n", leader1)
	cfg.checkOneLeader()

	// if the old leader rejoins, that shouldn't
	// disturb the old leader.
	cfg.connect(leader1)
	//PlainDPrintf("[IMPORTANT] After first leader's reconnection, all connect\n")
	...
	time.Sleep(2 * RaftElectionTimeout)
	//PlainDPrintf("[IMPORTANT] After total disconnection, only %d connects\n", (leader2 + 2) % servers)
	cfg.checkNoLeader()

	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	//PlainDPrintf("[IMPORTANT] After only one reconnection, only %d disconnects\n", leader2)
	cfg.checkOneLeader()
...
func TestBasicAgreePart2(t *testing.T) {
	servers := 5
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestFailAgreePart2(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
	...
	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] failed server %d re-connected", (leader + 1) % servers)
	//PlainDPrintf("")
...
func TestFailNoAgreePart2(t *testing.T) {
	servers := 5
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestConcurrentStartsPart2(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestRejoinPart2(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
	...
	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] after triple Start on disconnected old leader (%d)...", leader1)
	//PlainDPrintf("")
	...
	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] after cfg.one(103, 2)")
	//PlainDPrintf("")
	...
	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] after leader1 (%d)'s reconnection; at the same time, disconnected leader2 (%d)", leader1, leader2)
	//PlainDPrintf("")

	cfg.one(104, 2)

	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] before leader2 (%d)'s reconnection", leader2)
	//PlainDPrintf("")
	...
	//PlainDPrintf("")
	//PlainDPrintf("[IMPORTANT] after leader2 (%d)'s reconnection", leader2)
	//PlainDPrintf("")
...
func TestBackupPart2(t *testing.T) {
	servers := 5
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestPersist1Part3(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestPersist2Part3(t *testing.T) {
	servers := 5
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestPersist3Part3(t *testing.T) {
	servers := 3
	cfg := make_config(t, servers, false)
	defer cfg.cleanup()
...
func TestFigure8Part3(t *testing.T) {
	...
	for iters := 0; iters < 1000; iters++ {
		if iters % 10 == 0 {
			//PlainDPrintf("[IMPORTANT] iters = %d\n", iters)
		}
		leader := -1
		for i := 0; i < servers; i++ {
			if cfg.rafts[i] != nil {
...
func TestUnreliableAgreePart3(t *testing.T) {
	servers := 5
...
func TestFigure8UnreliablePart3(t *testing.T) {
	servers := 5
	cfg := make_config(t, servers, true)
	defer cfg.cleanup()
	...
	PlainDPrintf("[IMPORTANT] before the last cfg.one!!!")

	cfg.one(rand.Int()%10000, servers)

	PlainDPrintf("[IMPORTANT] after the last cfg.one!!!")
...
func TestReliableChurnPart3(t *testing.T) {
	internalChurn(t, false)
}

func TestUnreliableChurnPart3(t *testing.T) {
